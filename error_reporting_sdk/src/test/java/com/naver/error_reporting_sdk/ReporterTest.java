...
public class ReporterTest {
    ...
    @Test
    public void getDiffTimeWithServer() {
        System.out.println(Reporter.getDiffTimeWithServer());
    }

    @Test
    public void hasDiffTime() {
        assertTrue(Reporter.hasDiffTime());
    }
    ...
    @Test
    public void setDifferentTimeFromServer() {
        Reporter.setDifferentTimeFromServer(application);
